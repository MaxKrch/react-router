...
describe('PostForm component', async () => {
    ...
    describe('Rendering', () => {
        ...
        it('renders hidden inputs in edit mode', () => {
            ...
            expect(screen.getByPlaceholderText(/Type your text/i)).toHaveValue(mockPost.content)
            expect(screen.getByDisplayValue(mockPost.id as number)).toBeInTheDocument()
            expect(screen.getByDisplayValue(mockPost.created as number)).toBeInTheDocument()
        });
    });
