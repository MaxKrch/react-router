...
function DriftPage() {
  return (
    <article className="race-article">
      <h1 className="race-article__title">Дрифт-такси</h1>
      <p className="race-article__paragraph">
...
function ForzaPage() {
  return (
    <article className="race-article">
      <h1 className="race-article__title">Forza Karting Sochi</h1>
      <p className="race-article__paragraph">
...
function TimeAttackPage() {
  return (
    <article className="race-article">
      <h1 className="race-article__title">Гонка ​​​​​​Time Attack</h1>
      <p className="race-article__paragraph">
