...
describe("Network Actions", () => {
    ...
    describe("updatePostAction", () => {
        ...
        it("throw error, when empty id", async () => {
            ...
            await expect(actions.updatePostAction({ request } as any)).rejects.toThrow("Post ID is missing");
        });
    });
    ...
    describe("deletePostAction", () => {
        ...
        it("throw error, when empty id", async () => {
            await expect(actions.deletePostAction({ params: {} } as any)).rejects.toThrow("Post ID is missing");
        });
    });
